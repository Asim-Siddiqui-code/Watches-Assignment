var watches = {
  ...
  let productSelected = document.getElementById("productSelected");
  ...
  function searchProduct() {
    for (var keys in watches[selectedBrand]) {
      if (watches[selectedBrand][keys].name === selectedProduct) {
        ...
        name.innerText = watches[selectedBrand][keys].name;
        price.innerText = watches[selectedBrand][keys].price;
        desc.innerText = watches[selectedBrand][keys].caption;
